...
6. Look for the app file, such as `neuroswift.exe`.
...
4. Finish the setup.
5. Open neuroswift from the Start menu or desktop shortcut.
...
4. Wait for the first launch to finish loading.
...
- `C:\neuroswift\` for the app
- `C:\neuroswift\models\` for model files
